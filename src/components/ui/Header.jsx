...
export default function Header() {
  return (
    <header className="fixed top-0 z-30 flex h-16 w-full items-center justify-between border-b border-outline-variant/30 bg-background/80 px-4 backdrop-blur-xl md:h-20 md:px-8 md:pl-80">
